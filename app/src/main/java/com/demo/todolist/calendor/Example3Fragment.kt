...
import com.demo.todolist.calendor.BaseFragment
import com.demo.todolist.calendor.HasBackButton
import com.demo.todolist.databinding.Example3CalendarDayBinding
import com.demo.todolist.databinding.Example3CalendarHeaderBinding
import com.demo.todolist.databinding.Example3EventItemViewBinding
import com.demo.todolist.databinding.Example3FragmentBinding
...
class Example3Fragment : BaseFragment(R.layout.example_3_fragment), HasBackButton {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        class MonthViewContainer(view: View) : ViewContainer(view) {
            val legendLayout = Example3CalendarHeaderBinding.bind(view).legendLayout
        }
